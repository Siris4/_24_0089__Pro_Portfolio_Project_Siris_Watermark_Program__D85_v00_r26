...
def update_text_watermark():
    ...
    # Apply copyright symbol at the beginning or end of the text based on user selection
    if include_copyright.get() == "beginning":
        text = f"© {text}"
    elif include_copyright.get() == "end":
        text = f"{text} ©"
...
include_copyright = tk.StringVar(value="none")  # Options: none, beginning, end
copyright_begin_radio = tk.Radiobutton(root, text="Include © at Beginning", variable=include_copyright, value="beginning", command=apply_watermark)
copyright_end_radio = tk.Radiobutton(root, text="Include © at End", variable=include_copyright, value="end", command=apply_watermark)
copyright_none_radio = tk.Radiobutton(root, text="No © Symbol", variable=include_copyright, value="none", command=apply_watermark)
copyright_begin_radio.pack(pady=5)
copyright_end_radio.pack(pady=5)
copyright_none_radio.pack(pady=5)
