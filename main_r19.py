...
# Checkbox to toggle white text
white_text = tk.BooleanVar()  # Variable to track the white text checkbox
white_text_checkbox = tk.Checkbutton(root, text="White Text", variable=white_text, command=apply_watermark)
white_text_checkbox.pack(pady=5)
