...
# Create frames for left (Text Features) and right (Image Features)
left_frame = tk.Frame(root, width=400, height=600, padx=10, pady=10)
left_frame.grid(row=0, column=0, sticky="nsew")

right_frame = tk.Frame(root, width=400, height=600, padx=10, pady=10)
right_frame.grid(row=0, column=2, sticky="nsew")

# Create a vertical line between the two frames
separator = tk.Canvas(root, width=2, height=600, bg="black")
...
load_button = tk.Button(right_frame, text="Load Image", command=load_image)
...
image_label.grid(row=1, column=0, columnspan=3, pady=20)
